...
def jobTitle = Defaults.DEFAULT_PREFIX + "-delete-namespace-and-pv-cleanup-job"

freeStyleJob("${jobTitle}") {
    description Defaults.description(
        "This job contains script for deleting namespace and stuck PVs and PVCs.",
    ...
    parameters {
        ...
        choiceParam('ACTIVE_SITE', Defaults.all_env_list, 'Select environment.')
                ...
                --env PYTHONPATH=/workdir \
                 ${TEST_DOCKER_IMAGE} \
                    /bin/bash -c "source venv/bin/activate && \
                     python util_scripts/common/persistent_volume_cleaner.py"
        ''')
    }
}
