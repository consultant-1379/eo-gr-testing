...
def jobTitle = Defaults.DEFAULT_PREFIX + "-rv-verify-update-recovery-state-robustness-scenario"

pipelineJob(jobTitle) {

    description Defaults.description(
        "This pipeline verifies update recovery state procedure for site.",
    ...
    parameters {
        ...
        stringParam("GR_STAGE_SHARED_NAME", "recovery", "Provide unique name for CVNFM and VMVNFM tests assets or it will generated automatically.")
    ...
    definition {
            cps {
                script(readFileFromWorkspace(Defaults.GR_ROBUSTNESS_PATH + "eo_gr_rv_verify_update_recovery_state_scenario.Jenkinsfile"))
                sandbox()
            }
        }
