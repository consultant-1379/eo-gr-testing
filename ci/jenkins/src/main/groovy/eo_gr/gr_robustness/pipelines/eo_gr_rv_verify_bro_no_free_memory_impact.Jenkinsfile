...
/**
 * This pipeline sets up the environment and executes test_switchover_no_free_space_on_bro_pod (OTC-14187).
 * For detailed information on the stages, please refer to EO-174525.
 */
            ...
            steps {
                script {
                    ...
                    parameters: [
                        ...
                        string(name: 'PASSIVE_SITE', value: env.PASSIVE_SITE),
                        string(name: 'VIM', value: env.VIM),
                        string(name: 'TEST_TAG', value: 'switchover_no_free_space_on_bro_pod'),
                        booleanParam(name: 'USE_LOCAL_DNS', value: env.USE_LOCAL_DNS),
                        string(name: 'DEPLOYMENT_MANAGER_VERSION', value: env.DEPLOYMENT_MANAGER_VERSION),
