...
def jobTitle = Defaults.DEFAULT_PREFIX + "-rv-verify-active-site-not-available-basic-scenario"

pipelineJob(jobTitle) {

    description Defaults.description(
        """This pipeline verifies EO GR switchover operation when Active site not available""",
    ...
    parameters {
        ...
        stringParam("GR_STAGE_SHARED_NAME", "active-site-not-available", "Provide unique name for CVNFM and VMVNFM tests assets or it will generated automatically.")
    ...
    definition {
            cps {
                script(readFileFromWorkspace(Defaults.GR_BASIC_PATH + "eo_gr_rv_verify_active_site_not_available_scenario.Jenkinsfile"))
                sandbox()
            }
        }
